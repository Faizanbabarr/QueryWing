      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">
            ...
            {status === 'error' && 'Account Creation Failed'}
          </CardTitle>
          <p className="text-gray-600 mt-2">
            {status === 'loading' && 'Please wait while we create your account.'}
            {status === 'success' && 'Your account has been created successfully. Redirecting to dashboard...'}
            {status === 'error' && 'There was an issue creating your account. Please try again.'}
          </p>
        </CardHeader>
